...
public:
    ...
    void outLog(int itr, int no_checked, vector<int> &u, vector<int> &x, vector<vector<int>> &xm, vector<double> &y, vector<vector<double>> &ym, vector<int> &u_n_est, ofstream &val_file, ofstream &check_file ,vector<vector<double> > &node_value, vector<vector<bool> > &node_isChecked);
